<template>
  <div id="userList">
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%; text-align:center;" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="id" align="center" label="用户ID" width="80"></el-table-column>
      <el-table-column prop="author" align="center" label="用户名" width="240px"></el-table-column>
      <el-table-column prop="title" align="center" label="企业名称" width="500px"></el-table-column>
      <el-table-column prop="author" align="center" label="角色" width="240px"></el-table-column>
