    ...
    children: [
      {
        ...
        name: 'project',
        meta: { title: '工程管理', icon: 'tab', roles: ['admin', 'editor'] }
      },
      {
        path: 'create',
        ...
        name: 'projectCreate',
        hidden: true,
        meta: { title: '工程创建', icon: 'tab', roles: ['editor'] }
      },
      {
        path: 'edit/:id(\\d+)',
        ...
        name: 'projectEdit',
        hidden: true,
        meta: { title: '工程编辑', icon: 'tab', roles: ['editor'] }
      },
      {
        path: 'detail/:id(\\d+)',
        ...
        name: 'projectDetail',
        hidden: true,
        meta: { title: '工程详情', icon: 'tab', roles: ['admin', 'editor'] }
      }
    ]
  },
